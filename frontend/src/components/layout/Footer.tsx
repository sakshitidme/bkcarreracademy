...
export const Footer: React.FC<FooterProps> = ({ setView, setSelectedCategory, setIsRegistrationModalOpen, setSelectedExamName }) => {
  return (
    <footer className="bg-white border-t border-gray-100 pt-0 pb-4">
      <div className="max-w-[1600px] w-full mx-auto px-6 md:px-12 lg:px-16 pt-6 pb-6 md:pt-8 md:pb-8">
