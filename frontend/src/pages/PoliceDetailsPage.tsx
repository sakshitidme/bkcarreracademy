      ...
      <header className="pt-20 pb-10 px-8 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-display font-black text-ink uppercase tracking-tight leading-none">
            महाराष्ट्र <span className="text-brand">पोलीस</span> भरती
          </h1>
      ...
      <section className="bg-ink py-24 px-8 text-center border-t-8 border-brand">
         <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-6xl font-display font-black text-white uppercase mb-8">
              Join the <span className="text-red-600">BK</span> <span className="text-brand">Career Academy</span> Police Force Batch
            </h2>
